...
import { Box, Button, capitalize, Card, CardActions, CardMedia, Checkbox, Chip, Divider, FormControl, FormControlLabel, FormGroup, FormLabel, Grid, Input, Radio, RadioGroup, TextField } from '@mui/material';
...
const ProductAdminPage: FC<Props> = ({ product }) => {
    ...
    const onFileSelected = async ({ target }: ChangeEvent<HTMLInputElement>) => {
        ...
        //FormData ya tiene en el navegador web
        try {
    ...
    const onSubmit = async (form: FormData) => {
        ...
        try {
            console.log('llamo a tesloapi')
            const { data } = await tesloApi(
                {
                    url: '/admin/products',
                    method: form._id ? 'PUT' : 'POST', // si tenemos _id, entonces actualizar, sino, crear

                    data: form
                }
            )
            console.log('fin a tesloapi')
